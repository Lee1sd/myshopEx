...
public class CartController {
    ...
    public String orderHistory(Principal principal, Model model) {
        ...
        model.addAttribute("cartItemes", cartDetailList);
    ...
    public @ResponseBody ResponseEntity deletCartItem(@PathVariable("cartItemId") Long cartItemId, Principal principal){
