...
import com.example.myShop.repository.ItemRepositoryTest;
...
public class ItemServiceTest {
    ...
    @Autowired
    ItemRepositoryTest itemRepository;
    ...
    List<MultipartFile> createMultipartFiles() throws Exception{
        ...
        for(int i=0; i<5; i++){
            ...
            String imagesName ="image" + i + ".jpg";
            MockMultipartFile multipartFile =
                    new MockMultipartFile(path, imagesName, "image/jpg", new byte[]{1,2,3,4});
